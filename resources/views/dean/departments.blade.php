  ...
  <div class="main">
    ...
    <div id="page-departments" class="page active">
      <div id="dept-list-view">
        <div style="margin-bottom:20px;"><div style="font-size:20px;font-weight:800;">Department Overview</div><div style="font-size:13px;color:var(--text3);margin-top:3px;">Select a department to view details and faculty</div></div>
        <div class="three-col">
          <div class="dept-card" onclick="openDept('bsis')">
            <div class="dept-card-header"><div><div class="dept-card-code" style="color:var(--blue)">BSIS</div><div class="dept-card-name">Bachelor of Science in Information Systems</div></div><span class="dept-card-arrow">›</span></div>
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"><div style="background:var(--grey);border-radius:8px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;">8</div><div style="font-size:11px;color:var(--text3)">Faculty</div></div><div style="background:var(--grey);border-radius:8px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;">23</div><div style="font-size:11px;color:var(--text3)">Sections</div></div></div>
            <div style="margin-bottom:8px;font-size:12px;font-weight:600;color:var(--text2)">Avg Load: 22h / 30h max</div>
            <div class="workload-bar"><div class="workload-fill" style="width:73%;background:var(--blue)"></div></div>
            <div style="margin-top:12px;display:flex;justify-content:space-between;"><span class="badge badge-green">Submitted</span><span class="badge badge-blue">Chair: R. Tan</span></div>
          </div>
          <div class="dept-card" onclick="openDept('bsit')">
            <div class="dept-card-header"><div><div class="dept-card-code" style="color:var(--purple)">BSIT</div><div class="dept-card-name">Bachelor of Science in Information Technology</div></div><span class="dept-card-arrow">›</span></div>
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"><div style="background:var(--grey);border-radius:8px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;">7</div><div style="font-size:11px;color:var(--text3)">Faculty</div></div><div style="background:var(--grey);border-radius:8px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;">19</div><div style="font-size:11px;color:var(--text3)">Sections</div></div></div>
            <div style="margin-bottom:8px;font-size:12px;font-weight:600;color:var(--text2)">Avg Load: 24h / 30h max</div>
            <div class="workload-bar"><div class="workload-fill" style="width:80%;background:var(--amber)"></div></div>
            <div style="margin-top:12px;display:flex;justify-content:space-between;"><span class="badge badge-amber">Has Conflicts</span><span class="badge badge-purple">Chair: M. Cruz</span></div>
          </div>
          <div class="dept-card" onclick="openDept('bitct')">
            <div class="dept-card-header"><div><div class="dept-card-code" style="color:var(--teal)">BIT-CT</div><div class="dept-card-name">Bachelor of Industrial Tech — Computer Technology</div></div><span class="dept-card-arrow">›</span></div>
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;"><div style="background:var(--grey);border-radius:8px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;">4</div><div style="font-size:11px;color:var(--text3)">Faculty</div></div><div style="background:var(--grey);border-radius:8px;padding:10px;text-align:center;"><div style="font-size:20px;font-weight:800;">10</div><div style="font-size:11px;color:var(--text3)">Sections</div></div></div>
            <div style="margin-bottom:8px;font-size:12px;font-weight:600;color:var(--text2)">Avg Load: 18h / 30h max</div>
            <div class="workload-bar"><div class="workload-fill" style="width:60%;background:var(--teal)"></div></div>
            <div style="margin-top:12px;display:flex;justify-content:space-between;"><span class="badge badge-green">Submitted</span><span class="badge badge-teal">Chair: J. Lim</span></div>
          </div>
        </div>
      </div>
      <div id="dept-detail-view" style="display:none;">
        <button class="topbar-btn btn-secondary" onclick="closeDept()" style="margin-bottom:20px;">Back to Departments</button>
