...
<div id="screen-app" class="screen active" style="flex-direction:row;">
 ...
 @include('partials.dean_sidebar')
  ...
  <div class="main">
    ...
    <!-- FACULTY DEPLOYMENT PAGE -->
    <div id="page-deployment" class="page active">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;"><div><div style="font-size:20px;font-weight:800;">Faculty Deployment Report</div></div><button class="topbar-btn btn-primary" onclick="openModal('modal-export')">Export PDF</button></div>
      <div class="card"><table><thead><tr><th>#</th><th>Faculty Name</th><th>Department</th><th>Subjects</th><th>Total Load</th><th>Employment</th></tr></thead><tbody>
        <tr><td>1</td><td><b>Jerome Bautista</b></td><td>BSIS</td><td>CC 313, CC 401, IT 302</td><td>24h</td><td>Full-time</td></tr>
        <tr><td>2</td><td><b>Ana Reyes</b></td><td>BSIT</td><td>IT 401, CC 201, GE 101</td><td>27h</td><td>Part-time</td></tr>
        <tr><td>3</td><td><b>Carlo Mendoza</b></td><td>BSIT</td><td>CC 101, CC 102, IT 201, CC 311</td><td style="color:var(--red)">31h</td><td>Full-time</td></tr>
        <tr><td>4</td><td><b>Maria Santos</b></td><td>BSIS</td><td>GE 102, IT 101</td><td>18h</td><td>Full-time</td></tr>
      </tbody></table></div>
    </div>
